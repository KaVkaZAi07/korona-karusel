...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative bg-bg py-12 md:py-20 overflow-hidden transition-colors duration-500"
    >
      ...
      <div className="relative z-10 w-full overflow-hidden mb-8 select-none py-2 border-y border-stroke/30 bg-black/10 backdrop-blur-[2px]">
        <div
          ref={marqueeRef}
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 md:px-10 lg:px-16">
        <div className="max-w-4xl mx-auto text-center mb-8">
          ...
          >
            <span
              className={`text-xs uppercase tracking-[0.3em] font-semibold block mb-3 ${
            ...
            <h2
              className={`text-3xl md:text-5xl lg:text-6xl font-display italic leading-tight mb-6 ${
            ...
            {/* Authentic Contact Card Box with WhatsApp, Telegram, and Max */}
            <div className="bg-surface/85 backdrop-blur-md border border-stroke rounded-3xl p-6 sm:p-8 max-w-2xl mx-auto shadow-2xl text-left">
              ...
              {/* 3 Action Buttons: WhatsApp, Telegram, Max */}
              <div className="grid grid-cols-3 gap-2.5 mt-6 pt-4 border-t border-stroke/40">
                <a
                  href="https://wa.me/79165372315"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="py-2.5 px-3 rounded-2xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs sm:text-sm text-center transition-all shadow-md shadow-emerald-600/30 flex items-center justify-center gap-1.5"
                >
                  💬 WhatsApp
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="py-2.5 px-3 rounded-2xl bg-sky-600 hover:bg-sky-500 text-white font-bold text-xs sm:text-sm text-center transition-all shadow-md shadow-sky-600/30 flex items-center justify-center gap-1.5"
                >
                  ✈️ Telegram
                </a>
                <a
                  href="#"
                  className="py-2.5 px-3 rounded-2xl bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs sm:text-sm text-center transition-all shadow-md shadow-purple-600/30 flex items-center justify-center gap-1.5"
                >
                  ⚡ Max
                </a>
              </div>
        ...
        {/* Clean Compact Footer bar following right after the card */}
        <div className="border-t border-stroke/40 pt-5 mt-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
          <div className="flex items-center gap-2">
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75" />
              <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500" />
            </span>
            <span className={`text-xs font-semibold uppercase tracking-wider ${isLight ? "text-slate-700" : "text-muted"}`}>
              Качество • Комфорт • Забота о детях ♡
            </span>
          </div>

          <span className={`text-xs font-medium ${isLight ? "text-slate-500" : "text-muted"}`}>
            Корона × Карусель 2026
          </span>
        </div>
      </div>
    </section>
